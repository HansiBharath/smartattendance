...
const AttendancePage = () => {
  ...
  const navigationItems = [
    ...
    { icon: Users, label: "Attendance", active: true, path: "/student/attendance" },
  ...
  return (
    <div className="min-h-screen dashboard-background">
              ...
              <CardContent className="p-6">
                {currentStep === 2 ? (
                  <div className="text-center space-y-4">
                    <div className="w-64 h-64 mx-auto border-2 border-gray-300 rounded-lg bg-black overflow-hidden">
                      <QrScanner
                        onScan={(result) => handleQRScan({ text: result })}
                        onError={handleQRError}
                      />
                    </div>
                    <p className="text-gray-600">
                      Scan the live QR Code displayed in your class
                    </p>
                  ...
                  <div className="flex items-center gap-2 text-green-600">
                    <Check className="h-5 w-5" />
                    <span>
                      QR Code successfully scanned: {qrResult ? qrResult : "Verified"}
                    </span>
                  </div>
                )}
              </CardContent>
          ...
          {currentStep >= 3 && (
            ...
            >
              ...
              <CardContent className="p-6">
                {currentStep === 3 ? (
                  <div className="text-center space-y-4">
                    <FaceRecognition onVerified={() => {
                      setCurrentStep(4); // move to confirmation step
                      setAttendanceMarked(true);
                    }} />
                    <p className="text-gray-600">
                      Align your face within the frame for verification
                    </p>
                    <Button
                      onClick={() => {
                        setCurrentStep(4);
            ...
            <Card className="attendance-confirmation-card">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Your attendance has been recorded with the following details:
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left bg-gray-50 p-4 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      <strong>Register No:</strong> {registerNo}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      <strong>Location:</strong> Verified
                    </span>
                  </div>
                </div>
      ...
      <div className="flex justify-center items-center min-h-screen">
        <Card className="dashboard-card w-[400px] h-[400px] center">
          <CardHeader>
