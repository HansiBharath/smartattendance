...
const FacultyDashboard = () => {
  ...
  const [notificationOpen, setNotificationOpen] = useState(false);
    ...
    { icon: LayoutDashboard, label: "Dashboard",active: true, path: "/faculty/faculty-dashboard" },
  ...
  const notifications = [
    {
      ...
      message: "Weekly attendance summary is available for download.",
      time: "1 hour ago",
      priority: "high",
    },
    {
      ...
      type: "student",
      title: "Leave Request",
      message: "A student requested leave for tomorrow's class.",
      time: "3 hours ago",
      priority: "medium",
    },
    {
      ...
      type: "system",
      title: "System Update",
      message: "New feature added for curriculum management.",
      time: "1 day ago",
      priority: "low",
    },
  ];
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Welcome back, Professor! Here’s an overview of your day.</p>
          </div>
            ...
            <Card className="dashboard-card">
              ...
              <CardContent>
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">Class Average Attendance</p>
